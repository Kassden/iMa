...
def pipeline_manifest() -> dict:
    training = [
        ...
        _stage(
            ...
            "No parameters fitted",
            "Result and final odds are labels/benchmarks. They are not included in the 23 fundamental model features.",
        ),
        _stage(
            "train-history",
        ...
        _stage(
            ...
            "Convert the 23 raw feature columns into an estimator matrix.",
            ["17 numeric features", "6 categorical features"],
            [
        ...
        _stage(
            ...
            "Current WIN odds and market_probability are deliberately excluded from FEATURES and remain independently measurable.",
        ),
        _stage(
            "train-validation",
            ...
            [
                ...
                "Market blend: minimize validation race log loss for fundamental^wf * market^wm, wf and wm each bounded 0..4",
                "Fit Benter second- and third-place exponents independently in bounds 0.2..2.0",
            ],
            ["temperature", "fundamental_weight", "market_weight", "second exponent", "third exponent"],
    ...
    live = [
        ...
        _stage(
            "live-map",
            "Map scraper columns into the 23-feature contract",
            "Translate the live model CSV into the exact columns accepted by the trained pipeline.",
            ...
            ["Live DataFrame containing FEATURES", "ratable boolean", "win_odds"],
            "Uses preprocessing already fitted in the model artifact",
            "A feature may be collected but still not enter FEATURES. The feature contract below is authoritative.",
        ),
        _stage(
            "live-fundamental",
            ...
            "No live fitting",
            "The runner's current WIN odds do not enter this fundamental path.",
        ),
        _stage(
            "live-market",
            "Convert live WIN odds into market probability",
            "Represent the public market as a separate probability forecast.",
            ["decimal win_odds", "race_id", "odds_updated_at"],
            [
                "market_raw = 1 / win_odds for odds greater than 1",
                "Normalize market_raw within race so probabilities sum to 1",
            ],
            ["market_probability"],
            "No live fitting",
        ...
        _stage(
            ...
            ["calibrated fundamental", "market_probability", "fundamental_weight", "market_weight"],
            [
                "score = fundamental^fundamental_weight * market^market_weight",
            ...
            "Fundamental and market remain separately reportable; live data never refits their weights.",
        ),
        _stage(
            "live-fallback",
        ...
        _stage(
            ...
            "Pool-specific live market odds are not assigned arbitrary blend weights; they remain downstream price comparisons until timestamped history supports fitting.",
        ),
        _stage(
            "live-wager",
